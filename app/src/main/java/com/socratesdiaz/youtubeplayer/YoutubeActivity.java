        ...
        implements YouTubePlayer.OnInitializedListener
{
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        Toast.makeText(this, "Initialized YouTube Player succesfullly",  Toast.LENGTH_LONG).show();
    ...
    YouTubePlayer.PlayerStateChangeListener playerStateChangeListener =
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "Click Ad now, make the video creator rich! ",
